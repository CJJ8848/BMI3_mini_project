...
def read_and_decode(filename):
    ...
    return img, label
#initialize the epoch, batchi size and laerning rate
epoch = 10
batch_size = None
learning_rate = None
...
def CNN_2layers():
    ...
    h_conv1 = tf.nn.relu(conv(x, W_conv1) + b_conv1)  # relu as an activity function
...
if __name__ == '__main__':
    ...
    for l in learning_rate_choice:
        ...
        for b in batch_choice:
            ...
            y_conv, accuracy, train_step, keep_prob = CNN_2layers()
